...
./schedule-batch.sh ${FIELDTRIPDIR} ${DASHBOARDDIR}/logs/${REV}-R2017b '/opt/matlab/R2017b/bin/matlab -nodesktop -nosplash -nodisplay -singleCompThread'
./schedule-batch.sh ${FIELDTRIPDIR} ${DASHBOARDDIR}/logs/${REV}-R2017a '/opt/matlab/R2017a/bin/matlab -nodesktop -nosplash -nodisplay -singleCompThread'
./schedule-batch.sh ${FIELDTRIPDIR} ${DASHBOARDDIR}/logs/${REV}-R2016b '/opt/matlab/R2016b/bin/matlab -nodesktop -nosplash -nodisplay -singleCompThread'
./schedule-batch.sh ${FIELDTRIPDIR} ${DASHBOARDDIR}/logs/${REV}-R2016a '/opt/matlab/R2016a/bin/matlab -nodesktop -nosplash -nodisplay -singleCompThread'
./schedule-batch.sh ${FIELDTRIPDIR} ${DASHBOARDDIR}/logs/${REV}-R2015b '/opt/matlab/R2015b/bin/matlab -nodesktop -nosplash -nodisplay -singleCompThread'
./schedule-batch.sh ${FIELDTRIPDIR} ${DASHBOARDDIR}/logs/${REV}-R2015a '/opt/matlab/R2015a/bin/matlab -nodesktop -nosplash -nodisplay -singleCompThread'
./schedule-batch.sh ${FIELDTRIPDIR} ${DASHBOARDDIR}/logs/${REV}-R2014b '/opt/matlab/R2014b/bin/matlab -nodesktop -nosplash -nodisplay -singleCompThread'
./schedule-batch.sh ${FIELDTRIPDIR} ${DASHBOARDDIR}/logs/${REV}-R2014a '/opt/matlab/R2014a/bin/matlab -nodesktop -nosplash -nodisplay -singleCompThread'
./schedule-batch.sh ${FIELDTRIPDIR} ${DASHBOARDDIR}/logs/${REV}-R2013b '/opt/matlab/R2013b/bin/matlab -nodesktop -nosplash -nodisplay -singleCompThread'
